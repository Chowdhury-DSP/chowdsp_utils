...
CASE ("span<>: Terminates access outside the span")
{
    ...
    struct F
    {
        static void blow_ix (size_type i)
        {
            int arr[] = {
                1,
                2,
        ...
        static void blow_iv (size_type i)
        {
            int arr[] = {
                1,
                2,
        ...
        static void blow_at (size_type i)
        {
            int arr[] = {
                1,
                2,
...
CASE ("tweak header: reads tweak header if supported "
      "[tweak]")
{
