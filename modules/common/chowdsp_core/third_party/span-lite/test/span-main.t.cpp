...
CASE ("Presence of span library features"
      "[.span][.config]")
{
#if span_USES_STD_SPAN
...
CASE ("span configuration, contract level"
      "[.span][.config][.contract]")
{
#if span_USES_STD_SPAN
...
CASE ("Presence of C++ language features"
      "[.stdlanguage]")
{
...
CASE ("Presence of C++ library features"
      "[.stdlibrary]")
{
#if span_USES_STD_SPAN
