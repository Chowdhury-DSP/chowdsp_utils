...
/*`
    ...
    The following example shows how to do it using [funcref pfr::get_name].
...
*/
constexpr std::string_view n1 = pfr::get_name<0, foo>(); // returns "some_integer"
constexpr std::string_view n2 = pfr::get_name<1, foo>(); // returns "c"
//] [/pfr_example_get_name]
#endif
