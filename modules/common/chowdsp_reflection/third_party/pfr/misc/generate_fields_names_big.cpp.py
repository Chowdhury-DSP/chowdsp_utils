...
TEST_GET_NAME_CHECKER_TEMPLATE = """BOOST_TEST_EQ( ((pfr::get_name<%FIELD_ID%, Aggregate%STRUCT_ID%>())), "%FIELD_NAME%");
"""
...
TEST_GET_NAMES_AS_ARRAY_TEMPLATE = """void test_names_as_array_%TEST_ID%() {
    ...
    const auto value = pfr::names_as_array<Aggregate%STRUCT_ID%>();
