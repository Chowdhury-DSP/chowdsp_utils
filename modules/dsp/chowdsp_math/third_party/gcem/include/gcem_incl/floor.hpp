...
template <typename T>
constexpr int
    floor_resid (const T x, const T x_whole) noexcept
{
...
template <typename T>
constexpr T
    floor_int (const T x, const T x_whole) noexcept
{
...
template <typename T>
constexpr T
    floor_check_internal (const T x) noexcept
{
    return x;
}
...
template <>
constexpr float
    floor_check_internal<float> (const float x) noexcept
{
...
template <>
constexpr double
    floor_check_internal<double> (const double x) noexcept
{
...
template <typename T>
constexpr T
    floor_check (const T x) noexcept
{
    return ( // NaN check
