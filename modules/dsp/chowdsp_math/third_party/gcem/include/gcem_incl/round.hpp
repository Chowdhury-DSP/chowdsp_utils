...
template <typename T>
constexpr T
    round_check_internal (const T x) noexcept
{
    return x;
}
...
template <>
constexpr float
    round_check_internal<float> (const float x) noexcept
{
...
template <>
constexpr double
    round_check_internal<double> (const double x) noexcept
{
...
template <typename T>
constexpr T
    round_check (const T x) noexcept
{
    return ( // NaN check
