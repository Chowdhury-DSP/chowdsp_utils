...
template <typename T>
constexpr T
    erf_inv_initial_val_coef_2 (const T a, const T p_term, const int order) noexcept
{
    return (order == 1 ? T (-0.000200214257L) : order == 2 ? T (0.000100950558L) + a * p_term
...
template <typename T>
constexpr T
    erf_inv_initial_val_case_2 (const T a, const T p_term, const int order) noexcept
{
    return (order == 9 ? // if
...
template <typename T>
constexpr T
    erf_inv_initial_val_coef_1 (const T a, const T p_term, const int order) noexcept
{
    return (order == 1 ? T (2.81022636e-08L) : order == 2 ? T (3.43273939e-07L) + a * p_term
...
template <typename T>
constexpr T
    erf_inv_initial_val_case_1 (const T a, const T p_term, const int order) noexcept
{
    return (order == 9 ? // if
...
template <typename T>
constexpr T
    erf_inv_initial_val_int (const T a) noexcept
{
    return (a < T (5) ? // if
...
template <typename T>
constexpr T
    erf_inv_initial_val (const T x) noexcept
{
...
template <typename T>
constexpr T
    erf_inv_err_val (const T value, const T p) noexcept
{ // err_val = f(x)
    return (erf (value) - p);
}
...
template <typename T>
constexpr T
    erf_inv_deriv_1 (const T value) noexcept
...
template <typename T>
constexpr T
    erf_inv_deriv_2 (const T value, const T deriv_1) noexcept
...
template <typename T>
constexpr T
    erf_inv_ratio_val_1 (const T value, const T p, const T deriv_1) noexcept
{
...
template <typename T>
constexpr T
    erf_inv_ratio_val_2 (const T value, const T deriv_1) noexcept
{
...
template <typename T>
constexpr T
    erf_inv_halley (const T ratio_val_1, const T ratio_val_2) noexcept
{
...
template <typename T>
constexpr T
    erf_inv_recur (const T value, const T p, const T deriv_1, const int iter_count) noexcept
{
    return erf_inv_decision (value, p, erf_inv_halley (erf_inv_ratio_val_1 (value, p, deriv_1), erf_inv_ratio_val_2 (value, deriv_1)), iter_count);
}

template <typename T>
constexpr T
    erf_inv_decision (const T value, const T p, const T direc, const int iter_count) noexcept
{
...
template <typename T>
constexpr T
    erf_inv_recur_begin (const T initial_val, const T p) noexcept
{
...
template <typename T>
constexpr T
    erf_inv_begin (const T p) noexcept
{
    return ( // NaN check
