...
template <typename T>
constexpr T
    gcd_recur (const T a, const T b) noexcept
{
...
constexpr T
    gcd_int_check (const T a, const T b) noexcept
{
...
constexpr TC
    gcd_type_check (const T1 a, const T2 b) noexcept
{
...
constexpr common_t<T1, T2>
    gcd (const T1 a, const T2 b) noexcept
{
