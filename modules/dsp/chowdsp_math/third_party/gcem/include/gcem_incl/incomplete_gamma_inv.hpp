...
template <typename T>
constexpr T
    incomplete_gamma_inv_t_val_1 (const T p) noexcept
{ // a > 1.0
...
template <typename T>
constexpr T
    incomplete_gamma_inv_t_val_2 (const T a) noexcept
{ // a <= 1.0
...
template <typename T>
constexpr T
    incomplete_gamma_inv_initial_val_1_int_begin (const T t_val) noexcept
{ // internal for a > 1.0
    return (t_val - (T (2.515517L) + T (0.802853L) * t_val + T (0.010328L) * t_val * t_val) / (T (1) + T (1.432788L) * t_val + T (0.189269L) * t_val * t_val + T (0.001308L) * t_val * t_val * t_val));
}

template <typename T>
constexpr T
    incomplete_gamma_inv_initial_val_1_int_end (const T value_inp, const T a) noexcept
{ // internal for a > 1.0
...
template <typename T>
constexpr T
    incomplete_gamma_inv_initial_val_1 (const T a, const T t_val, const T sgn_term) noexcept
{ // a > 1.0
...
template <typename T>
constexpr T
    incomplete_gamma_inv_initial_val_2 (const T a, const T p, const T t_val) noexcept
{ // a <= 1.0
    return (p < t_val ? // if
                pow (p / t_val, T (1) / a)
                      :
...
template <typename T>
constexpr T
    incomplete_gamma_inv_initial_val (const T a, const T p) noexcept
{
    return (a > T (1) ? // if
...
template <typename T>
constexpr T
    incomplete_gamma_inv_err_val (const T value, const T a, const T p) noexcept
{ // err_val = f(x)
...
template <typename T>
constexpr T
    incomplete_gamma_inv_deriv_1 (const T value, const T a, const T lg_val) noexcept
...
template <typename T>
constexpr T
    incomplete_gamma_inv_deriv_2 (const T value, const T a, const T deriv_1) noexcept
...
template <typename T>
constexpr T
    incomplete_gamma_inv_ratio_val_1 (const T value, const T a, const T p, const T deriv_1) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_inv_ratio_val_2 (const T value, const T a, const T deriv_1) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_inv_halley (const T ratio_val_1, const T ratio_val_2) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_inv_recur (const T value, const T a, const T p, const T deriv_1, const T lg_val, const int iter_count) noexcept
{
    return incomplete_gamma_inv_decision (value, a, p, incomplete_gamma_inv_halley (incomplete_gamma_inv_ratio_val_1 (value, a, p, deriv_1), incomplete_gamma_inv_ratio_val_2 (value, a, deriv_1)), lg_val, iter_count);
}

template <typename T>
constexpr T
    incomplete_gamma_inv_decision (const T value, const T a, const T p, const T direc, const T lg_val, const int iter_count) noexcept
{
    ...
    return (iter_count <= GCEM_INCML_GAMMA_INV_MAX_ITER ? // if
                incomplete_gamma_inv_recur (value - direc, a, p, incomplete_gamma_inv_deriv_1 (value, a, lg_val), lg_val, iter_count + 1)
                                                        :
                                                        // else
                value - direc);
}
...
template <typename T>
constexpr T
    incomplete_gamma_inv_begin (const T initial_val, const T a, const T p, const T lg_val) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_inv_check (const T a, const T p) noexcept
{
    return ( // NaN check
...
constexpr TC
    incomplete_gamma_inv_type_check (const T1 a, const T2 p) noexcept
{
...
constexpr common_return_t<T1, T2>
    incomplete_gamma_inv (const T1 a, const T2 p) noexcept
{
