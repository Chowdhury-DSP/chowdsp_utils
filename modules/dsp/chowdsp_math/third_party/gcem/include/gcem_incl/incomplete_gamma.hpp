...
template <typename T>
constexpr T
    incomplete_gamma_quad_inp_vals (const T lb, const T ub, const int counter) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_quad_weight_vals (const T lb, const T ub, const int counter) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_quad_fn (const T x, const T a, const T lg_term) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_quad_recur (const T lb, const T ub, const T a, const T lg_term, const int counter) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_quad_lb (const T a, const T z) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_quad_ub (const T a, const T z) noexcept
{
    return (a > T (1000) ? min (z, a + 10 * sqrt (a)) : a > T (800) ? min (z, a + 10 * sqrt (a))
...
template <typename T>
constexpr T
    incomplete_gamma_quad (const T a, const T z) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_cf_2_recur (const T a, const T z, const int depth) noexcept
{
    return (depth < 100 ? // if
...
template <typename T>
constexpr T
    incomplete_gamma_cf_2 (const T a, const T z) noexcept
...
template <typename T>
constexpr T
    incomplete_gamma_cf_1_coef (const T a, const T z, const int depth) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_cf_1_recur (const T a, const T z, const int depth) noexcept
{
...
template <typename T>
constexpr T
    incomplete_gamma_cf_1 (const T a, const T z) noexcept
{ // lower (regularized) incomplete gamma function
...
template <typename T>
constexpr T
    incomplete_gamma_check (const T a, const T z) noexcept
{
    return ( // NaN check
...
constexpr TC
    incomplete_gamma_type_check (const T1 a, const T2 p) noexcept
{
...
constexpr common_return_t<T1, T2>
    incomplete_gamma (const T1 a, const T2 x) noexcept
{
