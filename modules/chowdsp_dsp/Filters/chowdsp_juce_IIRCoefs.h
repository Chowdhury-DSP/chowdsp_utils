...
struct Coefficients : public juce::dsp::ProcessorState
{
    ...
    */
    template <size_t N = order, typename = std::enable_if_t<N == 1>>
    ...
    template <size_t N = order, typename = std::enable_if_t<N == 2>>
    ...
    template <size_t N = order, std::enable_if_t<N == 3>>
    ...
    Coefficients (Coefficients&&) noexcept = default;
    Coefficients& operator= (const Coefficients&) = default;
    Coefficients& operator= (Coefficients&&) noexcept = default;
