...
public:
    ...
    {
        Version v1 ("1.2.3");
        expectEquals (v1.getVersionString(), juce::String ("1.2.3"), "Incorrect version string!");

        Version v2 ("v1.2.3");
        expectEquals (v2.getVersionString(), juce::String ("1.2.3"), "Incorrect version string!");
    }
