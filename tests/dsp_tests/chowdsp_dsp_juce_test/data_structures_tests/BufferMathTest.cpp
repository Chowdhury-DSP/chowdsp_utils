...
TEMPLATE_TEST_CASE ("Buffer Math Test",
                    ...
                    (chowdsp::StaticBuffer<float, 2, 4800>),
                    (chowdsp::StaticBuffer<double, 2, 4800>),
                    (chowdsp::StaticBuffer<xsimd::batch<float>, 2, 4800>),
                    (chowdsp::StaticBuffer<xsimd::batch<double>, 2, 4800>),
