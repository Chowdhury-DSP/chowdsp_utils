...
public:
    ...
    void firstOrderLPFTest (T maxError)
    {
        ...
        testFrequency (fc, Decibels::decibelsToGain ((T) -3), "Incorrect gain at cutoff frequency.");
        testFrequency (fc * (T) 4, Decibels::decibelsToGain ((T) -12.5), "Incorrect gain at high frequencies.");
    }
    ...
    void firstOrderHPFTest (T maxError)
    {
        ...
        testFrequency (fc / 4, Decibels::decibelsToGain ((T) -12.5), "Incorrect gain at low frequencies.");
        testFrequency (fc, Decibels::decibelsToGain ((T) -3), "Incorrect gain at cutoff frequency.");
        testFrequency (fc * (T) 10, (T) 1, "Incorrect gain at high frequencies.");
    }
