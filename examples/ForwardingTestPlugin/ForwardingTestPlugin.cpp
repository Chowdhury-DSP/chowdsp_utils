...
{
    using namespace chowdsp::ParamUtils;
    emplace_param<chowdsp::ChoiceParameter> (params, juce::ParameterID { processorChoiceParamID, 100 }, "Processor Choice", juce::StringArray { "None", "Tone Generator", "Reverb" }, 0);
