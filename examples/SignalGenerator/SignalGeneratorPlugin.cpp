...
void SignalGeneratorPlugin::addParameters (Parameters& params)
{
    ...
    emplace_param<chowdsp::ChoiceParameter> (params, juce::ParameterID { typeTag, 100 }, "Tone Type", juce::StringArray { "Sine", "Saw", "Square" }, 0);
    emplace_param<chowdsp::ChoiceParameter> (params, juce::ParameterID { upsampleTag, 100 }, "Upsample", juce::StringArray { "1x", "2x", "3x", "4x" }, 0);
    emplace_param<chowdsp::ChoiceParameter> (params, juce::ParameterID { waveshaperTag, 100 }, "Waveshaper", juce::StringArray { "None", "Hard Clip", "Tanh Clip", "Cubic Clip", "9th-Order Clip" }, 0);
}
