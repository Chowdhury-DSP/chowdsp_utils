...
private:
    using EQBand = chowdsp::EQ::EQBand<float,
                                       ...
                                       chowdsp::NthOrderFilter<float, 4, chowdsp::StateVariableFilter2Type::Highpass>,
                                       ...
                                       chowdsp::StateVariableFilter2<float, chowdsp::StateVariableFilter2Type::Notch>,
                                       //                                       chowdsp::NotchFilter<float>,
                                       chowdsp::HighShelfFilter<float>,
                                       chowdsp::FirstOrderLPF<float>,
                                       chowdsp::SecondOrderLPF<float>,
                                       chowdsp::NthOrderFilter<float, 4, chowdsp::StateVariableFilter2Type::Lowpass>,
