...
{
    chowdsp::OptionallyOwningPointer<chowdsp::PercentParameter> percent { "percent", "Percent" };
    chowdsp::OptionallyOwningPointer<chowdsp::GainDBParameter> gain { "gain", "Gain", juce::NormalisableRange { -30.0f, 0.0f }, 0.0f };
};
