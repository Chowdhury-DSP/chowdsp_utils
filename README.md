...
| Branch  | Tests                                                                                                                                                                                             | Examples                                                                                                                                                                                            | Benchmarks                                                                                                                                                                                      | Code Quality                                                                                                                                                                                                    | Coverage                                                                                                                                                         |
|---------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `master`| [![Test](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/run-tests.yml/badge.svg?branch=master)](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/run-tests.yml) | [![Examples](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/examples.yml/badge.svg?branch=master)](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/examples.yml) | [![Benchmarks](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/bench.yml/badge.svg?branch=master)](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/bench.yml) | [![Code-Quality](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/code-quality.yml/badge.svg?branch=master)](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/code-quality.yml) | [![codecov](https://codecov.io/gh/Chowdhury-DSP/chowdsp_utils/branch/master/graph/badge.svg?token=84B35MB5QS)](https://codecov.io/gh/Chowdhury-DSP/chowdsp_utils) |
| `next`  | [![Test](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/run-tests.yml/badge.svg?branch=next)](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/run-tests.yml)   | [![Examples](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/examples.yml/badge.svg?branch=next)](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/examples.yml)   | [![Benchmarks](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/bench.yml/badge.svg?branch=next)](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/bench.yml)   | [![Code-Quality](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/code-quality.yml/badge.svg?branch=next)](https://github.com/Chowdhury-DSP/chowdsp_utils/actions/workflows/code-quality.yml)   | [![codecov](https://codecov.io/gh/Chowdhury-DSP/chowdsp_utils/branch/next/graph/badge.svg?token=84B35MB5QS)](https://codecov.io/gh/Chowdhury-DSP/chowdsp_utils)  |
