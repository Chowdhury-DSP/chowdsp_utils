...
namespace dsp
{
    namespace chowdsp
    {
        ...
        namespace SIMDInternal
        {
            ...
            {
                using type = typename std::remove_cv<Primitive>::type;
            };
            template <typename Primitive>
...
*/
        ...
        struct SIMDFallbackOps
        {
            ...
            static forcedinline vSIMDType cmplxmul (vSIMDType av, vSIMDType bv) noexcept
            {
                ...
                for (int i = 0; i < m; ++i)
                {
                    std::complex<ScalarType> result = std::complex<ScalarType> (a.s[i << 1], a.s[(i << 1) | 1])
            ...
            struct ScalarAdd
            {
                static forcedinline ScalarType op (ScalarType a, ScalarType b) noexcept { return a + b; }
            };
            struct ScalarSub
            {
                static forcedinline ScalarType op (ScalarType a, ScalarType b) noexcept { return a - b; }
            ...
            struct ScalarMin
            {
                static forcedinline ScalarType op (ScalarType a, ScalarType b) noexcept { return jmin (a, b); }
            };
            struct ScalarMax
            {
                static forcedinline ScalarType op (ScalarType a, ScalarType b) noexcept { return jmax (a, b); }
            };
            struct ScalarAnd
            {
                static forcedinline MaskType op (MaskType a, MaskType b) noexcept { return a & b; }
            };
            struct ScalarOr
            {
                static forcedinline MaskType op (MaskType a, MaskType b) noexcept { return a | b; }
            ...
            struct ScalarEq
            {
                static forcedinline bool op (ScalarType a, ScalarType b) noexcept { return (a == b); }
            };
            struct ScalarNeq
            {
                static forcedinline bool op (ScalarType a, ScalarType b) noexcept { return (a != b); }
