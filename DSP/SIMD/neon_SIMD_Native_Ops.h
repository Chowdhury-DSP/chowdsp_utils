...
struct SIMDNativeOps<uint32_t>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<uint32_t, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (uint32_t, ckAllBitsSet);
    ...
    static forcedinline vSIMDType bit_not (vSIMDType a) noexcept                                { return bit_notand (a, vld1q_u32 ((uint32_t*) ckAllBitsSet)); }
...
struct SIMDNativeOps<int32_t>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<int32_t, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (int32_t, ckAllBitsSet);
    ...
    static forcedinline vSIMDType bit_not (vSIMDType a) noexcept                                { return bit_notand (a, vld1q_s32 ((int32_t*) ckAllBitsSet)); }
...
struct SIMDNativeOps<int8_t>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<int8_t, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (int8_t, ckAllBitsSet);
    ...
    static forcedinline vSIMDType bit_not (vSIMDType a) noexcept                               { return bit_notand (a, vld1q_s8 ((int8_t*) ckAllBitsSet)); }
...
struct SIMDNativeOps<uint8_t>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<uint8_t, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (uint8_t, ckAllBitsSet);
    ...
    static forcedinline vSIMDType bit_not (vSIMDType a) noexcept                               { return bit_notand (a, vld1q_u8 ((uint8_t*) ckAllBitsSet)); }
...
struct SIMDNativeOps<int16_t>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<int16_t, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (int16_t, ckAllBitsSet);
    ...
    static forcedinline vSIMDType bit_not (vSIMDType a) noexcept                               { return bit_notand (a, vld1q_s16 ((int16_t*) ckAllBitsSet)); }
...
struct SIMDNativeOps<uint16_t>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<uint16_t, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (uint16_t, ckAllBitsSet);
    ...
    static forcedinline vSIMDType bit_not (vSIMDType a) noexcept                               { return bit_notand (a, vld1q_u16 ((uint16_t*) ckAllBitsSet)); }
...
struct SIMDNativeOps<int64_t>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<int64_t, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (int64_t, ckAllBitsSet);
    ...
    static forcedinline vSIMDType bit_not (vSIMDType a) noexcept                               { return bit_notand (a, vld1q_s64 ((int64_t*) ckAllBitsSet)); }
...
struct SIMDNativeOps<uint64_t>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<uint64_t, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (uint64_t, ckAllBitsSet);
    ...
    static forcedinline vSIMDType bit_not (vSIMDType a) noexcept                                { return bit_notand (a, vld1q_u64 ((uint64_t*) ckAllBitsSet)); }
    static forcedinline vSIMDType min (vSIMDType a, vSIMDType b) noexcept                       { return fb::min (a, b); }
    static forcedinline vSIMDType max (vSIMDType a, vSIMDType b) noexcept                       { return fb::max (a, b); }
    static forcedinline vSIMDType equal (vSIMDType a, vSIMDType b) noexcept                     { return fb::equal (a, b); }
    static forcedinline vSIMDType notEqual (vSIMDType a, vSIMDType b) noexcept                  { return fb::notEqual (a, b); }
...
struct SIMDNativeOps<float>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<float, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (int32_t, ckAllBitsSet);
    DECLARE_NEON_SIMD_CONST (int32_t, ckEvenHighBit);
    DECLARE_NEON_SIMD_CONST (float, ckOne);
    ...
    static forcedinline vSIMDType bit_not (vSIMDType a) noexcept                               { return bit_notand (a, vld1q_f32 ((float*) ckAllBitsSet)); }
    ...
    static forcedinline vSIMDType cmplxmul (vSIMDType a, vSIMDType b) noexcept
    {
        ...
        return add (rr_ir, bit_xor (ii_ri, vld1q_f32 ((float*) ckEvenHighBit)));
    }
...
struct SIMDNativeOps<double>
{
    ...
    using fb = chowdsp::SIMDFallbackOps<double, vSIMDType>;

    //==============================================================================
    DECLARE_NEON_SIMD_CONST (int64_t, ckAllBitsSet);
    DECLARE_NEON_SIMD_CONST (int64_t, ckEvenHighBit);
    DECLARE_NEON_SIMD_CONST (double, ckOne);
