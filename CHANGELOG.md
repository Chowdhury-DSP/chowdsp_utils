...
## [2.5.0] - UNRELEASED
- Modified `chowdsp::CrossoverFilter` to use an arena instead of an internal bufffer.
  - BREAKING CHANGE: the API for `chowdsp::CrossoverFilter` and `chowdsp::ThreeWayCrossover` has changed.
